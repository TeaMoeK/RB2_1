...
namespace RB21.DatabaseDataSetTableAdapters {
...
SELECT ID, AdressID, Vorname, Zweitname, Nachname, Geburtstag, Geschlecht, DarfKK, DarfLG, KleinkaliberID, LuftgewehrID, HandschuhID, JackeID, PistoleID, Info, IstKoenig, IstVize, IstArchiviert FROM Personen WHERE (ID = SCOPE_IDENTITY())";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::RB21.Properties.Settings.Default.DatabaseConnectionString;
        }
        ...
        public virtual int Fill(DatabaseDataSet.PersonenDataTable dataTable) {
        ...
        public virtual DatabaseDataSet.PersonenDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseDataSet.PersonenDataTable dataTable = new DatabaseDataSet.PersonenDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseDataSet.PersonenDataTable dataTable) {
